...
public class FileTypeController implements  ParametersSearchController<FileTypeDto, FileType, SearchStringParameters>,
        GetByIdController<FileTypeDto, FileType> {
